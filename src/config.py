...
class FeatureConfig(BaseSettings):
    ...
    MODEL1_NAME: str = Field(default="us.meta.llama4-maverick-17b-instruct-v1:0")
    MODEL2_NAME: str = Field(default="o4-mini-2025-04-16")
    MODEL3_NAME: str = Field(default="gpt-4o-mini")
